...
.slider-selection.tick-slider-selection {
  background-image: linear-gradient(to bottom, #283375 0%, #39a5dc 100%);
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff283375', endColorstr='#ff39a5dc', GradientType=0);
  background-repeat: repeat-x;
}
.slider-track-low,
.slider-track-high {
