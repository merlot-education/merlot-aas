...
.btn-primary {
  background-color: #283375;
  background-image: linear-gradient(to bottom, #324092 0%, #283375 100%);
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff324092', endColorstr='#ff283375', GradientType=0);
  background-repeat: repeat-x;
  border-color: #283375;
  color: #fff;
}
