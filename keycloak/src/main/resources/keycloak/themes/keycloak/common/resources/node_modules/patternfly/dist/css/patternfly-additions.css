...
.slider-selection.tick-slider-selection {
  background-image: linear-gradient(to bottom, #283375 0%, #283375 100%);
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff283375', endColorstr='#ff283375', GradientType=0);
  background-repeat: repeat-x;
}
.slider-track-low,
.slider-track-high {
...
.bootstrap-select.btn-group .dropdown-menu > .selected > a {
  background-color: #283375 !important;
  border-color: #283375 !important;
  color: #fff !important;
}
...
.list-view-pf-dnd .list-group-item-header:before {
  background-image: linear-gradient(to bottom, #283375 60%, #fff 0%);
  background-position: left;
  background-repeat: repeat-y;
  background-size: 2px 5px;
  border: 4px solid #283375;
  border-color: #20295E;
  content: "";
  height: 55px;
  left: 4px;
