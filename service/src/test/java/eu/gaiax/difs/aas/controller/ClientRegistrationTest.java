...
public class ClientRegistrationTest {
    ...
    void readClientTest() throws Exception {
        ...
        assertEquals(clientSecret, client.get(OidcClientMetadataClaimNames.CLIENT_SECRET).toString());
    ...
    void registerClientTest() throws Exception {
    	...
    	// client secret is encrypted now, think how to decrypt it and compare..
    	//assertEquals(client.get(OidcClientMetadataClaimNames.CLIENT_SECRET).toString(), reClient.getClientSecret());
