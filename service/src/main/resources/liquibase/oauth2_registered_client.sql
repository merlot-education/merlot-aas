...
VALUES 
    ('9a9135be-5923-4d96-aefe-bf275ef14087', 'aas-app-oidc', '2023-04-19 01:32:00.866534', '{noop}secret', null, 'SSI OIDC Keycloak Client', 'client_secret_basic,client_secret_post', 
     ...
     '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-authorization-consent":false,"settings.client.token-endpoint-authentication-signing-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.client.require-proof-key":false,"ssi_auth_type":"OIDC"}', 
